...
+(NSDictionary *) clientCredentials
{
    NSDictionary *clientDict = @{
                                 TENANT_NAME : @"PLEASE_LOOK_FOR_CREDENTIALS_AND_CONFIGURATION",
                                 CLIENT_ID : @"PLEASE_LOOK_FOR_CREDENTIALS_AND_CONFIGURATION",
                                 CLIENT_SECRET : @"PLEASE_LOOK_FOR_CREDENTIALS_AND_CONFIGURATION",
                                 APP_CODE : @"PLEASE_LOOK_FOR_CREDENTIALS_AND_CONFIGURATION",
                                 SERVER_NAME : @"PLEASE_LOOK_FOR_CREDENTIALS_AND_CONFIGURATION"                                 };
