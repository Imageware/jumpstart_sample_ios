 ...
 * Author(s)	: cbrooks
 *
 * Description	: The GMIBiometricProbe class is a container for CaptureSamples that we're sending to the server.
 */

#import "GMIConstant.h"

@interface GMIBiometricProbe : NSObject

@property NSMutableArray* datas;
@property NSArray *liveness;
